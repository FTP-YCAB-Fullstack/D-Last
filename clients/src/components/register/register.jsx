                ...
                <div className="w-full py-6 z-20">
                    ...
                    <form onSubmit={submited} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        <div className="pb-2 pt-4">
                            <input type="text" placeholder="type your name here" onChange={(e)=>setNama(e.target.value)} className="block w-full p-4 text-lg rounded-sm bg-black"/>
                        </div>
                        <div className="pb-2 pt-4">
                            <input type="email" placeholder="type your email here" onChange={(e)=>setEmail(e.target.value)} className="block w-full p-4 text-lg rounded-sm bg-black"/>
                        </div>
                        <div className="pb-2 pt-4">
                        ...
                        <div className="px-4 pb-2 pt-4">
                            <input type="submit" value="Sign Up" className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none"/>
                        </div>
                    </form>
                </div>
            </div>
