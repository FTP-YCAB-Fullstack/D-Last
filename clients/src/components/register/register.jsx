        ...
        <section class="min-h-screen flex items-stretch text-white ">
            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" >
                ...
                <div class="w-full py-6 z-20">
                    <h1 class="my-6 text-black text-5xl">
                        SIGN UP 
                    ...
                    <form onSubmit={submited} class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        <div class="pb-2 pt-4">
                            <input type="text" placeholder="type your name here" onChange={(e)=>setNama(e.target.value)} class="block w-full p-4 text-lg rounded-sm bg-black"/>
                        </div>
                        <div class="pb-2 pt-4">
                            <input type="email" placeholder="type your email here" onChange={(e)=>setEmail(e.target.value)} class="block w-full p-4 text-lg rounded-sm bg-black"/>
                        </div>
                        <div class="pb-2 pt-4">
                            <input type="password" placeholder="type your password here" onChange={(e)=>setPassword(e.target.value)} class="block w-full p-4 text-lg rounded-sm bg-black" />
                        </div>
                        <div class="px-4 pb-2 pt-4">
                            <input type="submit" value="Sign Up" class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none"/>
                        </div>
                    </form>
                </div>
            </div>
