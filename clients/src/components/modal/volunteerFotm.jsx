    ...
    <div className="modalBg w-full h-full top-0 left-0 bg-opacity-50 bg-black fixed flex justify-center items-center">
      <div className="modalcheck overflow-auto w-full h-full items-center flex flex-col p-4 bg-white">
        <div className="w-3/4 t-0 mb-8 rounded shadow-2xl p-5 ">
          <h1 className="w-full text-center text-gray-800 text-xl font-bold mb-4">
            Volunteer Form
          </h1>
          <form
            onSubmit={submit}
          ...
          >
            <div className="flex flex-col mb-4">
              <label className="mb-2 font-bold text-md text-gray-900">
                Tanggal Lahir
              </label>
              <DatePicker
                dateFormat="dd/MM/yyyy"
                selected={ttl}
                onChange={(date) => setttl(date)}
                showYearDropdown
            ...
            <div className="flex flex-col mb-4">
              <label
                className="mb-2 font-bold text-md text-gray-900"
                for="textarea"
              >
            ...
            <div className="flex flex-col mb-4">
              ...
              <textarea
                onChange={(e) => setPandangan(e.target.value)}
                className="border py-2 px-3 text-grey-800"
                name="textarea"
                id="textarea"
              ></textarea>
            ...
            <div className="flex flex-col mb-4">
              ...
              >
                {" "}
                Kalau kamu jadi volunteer, rencana yang akan kamu lakukan apa?
              </label>
              <textarea
            ...
            <div className="md:flex md:items-center">
              <div className="md:w-1/3">
                <input
                  type="submit"
                  value="Kirim"
                  className="shadow bg-green-600 mr-12 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
                />
                <button
