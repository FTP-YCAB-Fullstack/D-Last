            ...
            <div className="modalcheck h-full items-center justify-center flex flex-col p-4 gap-y-4 bg-white w-full">
                <form className="w-2/3 h-5/6 bg-blue-300 rounded-lg shadow-lg p-4 overflow-auto">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <input className=" appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-gray-200 focus:border-gray-500" id="message"></input>
