            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" >
                ...
                <div class="w-full py-6 z-20">
                    ...
                    <form onSubmit={submited} class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        ...
                        <div class="text-right text-black hover:underline hover:text-gray-100">
                            <Link to="/register">Daftar disini</Link>
                        </div>
                        <div class="px-4 pb-2 pt-4">
                            <input type="submit" value="Login" class="uppercase block w-full p-4 text-lg rounded-full bg-blue-300 hover:bg-blue-500 focus:outline-none"/>
                        </div>
                    </form>
                </div>
            </div>
