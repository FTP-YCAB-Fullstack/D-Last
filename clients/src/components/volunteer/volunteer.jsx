    ...
    return (
        <div>
            ...
            <div className="volunteer w-full h-screen flex flex-col items-center p-10 px-4 sm:px-6 lg:px-4 py-12">
                ...
                <div className="volunteer-box w-full h-72 bg-red-200 flex flex-wrap items-center justify-center gap-10">
                ...
                <h1 className="mt-20 bg-red-200">VOLUNTEER ACTIVITY</h1>
                        ...
                        return(
                            <>
                                <div className="w-80 bg-gray-100 rounded-lg p-8 flex flex-col justify-center items-center">
                                    <div className="mb-8">
                                        <img className="object-center object-cover h-32 w-32" src={`http://localhost:5000/${el.thumbnail}`} alt="photo"/>
                                    </div>
                                    <div className="text-center">
                                        <p className="text-xl text-gray-700 font-bold mb-2">{el.nama_kegiatan}</p>
                                        <p className="text-base text-gray-400 font-normal">{el.createdAt.slice(0,10)}</p>
                                    </div>
                                ...
                                {openAct && <ActivitiesModal close={setOpenAct} {...dataCard}/>}
                            </>
                        )
                    })}
